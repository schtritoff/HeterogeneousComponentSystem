...
{
    public class OpenClTransformation 
    {
        // Form for platform, device and kernel selection
        private OpenClDeviceForm _openClDeviceForm;
        private ComputeDeviceTypes _computeDeviceTypes;

        public void ChooseDevices(ComputeDeviceTypes deviceTypes)
        {
            if (_openClDeviceForm == null)
            {
                _openClDeviceForm = new OpenClDeviceForm(deviceTypes);
                _computeDeviceTypes = deviceTypes;
            }
        ...
        public Bitmap TransformImageOpenCl(Bitmap sourceImage)
        {
            ...
            var context = new ComputeContext(_computeDeviceTypes, cpl, null, IntPtr.Zero);
